<?php
    ...
    if(isset($_POST["user_btn"])){
        ...
        $insert = $car->create_user($fname,$lname,$email,$phone,$passport,$fileName,$country,$rotary,$status,$role,$password);
        if($insert){
                    ...
                    ?>
                        ...
                        <form method="POST" action="" enctype="multipart/form-data" class="row g-3 py-5">
                            ...
                            <div class="col-md-2"> 
                                ...
                                <input class="form-check-input" type="checkbox" required  name="status" value="" id="">
                                </div>
                            </div>
                            <div class="col-md-10"> 
